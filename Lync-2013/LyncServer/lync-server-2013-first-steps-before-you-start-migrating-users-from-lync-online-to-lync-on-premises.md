...
在开始将 Lync Online 用户移动到本地环境之前，请检查以下所有条件是否为 true：
  ...
  - 必须为远程 PowerShell 访问配置 Lync Online 租户。
    ...
    若要执行此操作，请首先安装适用于 Windows PowerShell 的 Lync Online 模块，可在此处获取： [https://go.microsoft.com/fwlink/p/?LinkId=391911](https://go.microsoft.com/fwlink/p/?linkid=391911) 。
