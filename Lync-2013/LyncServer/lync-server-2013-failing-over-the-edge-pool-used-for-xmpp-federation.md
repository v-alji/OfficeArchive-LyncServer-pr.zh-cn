...
1.  如果尚未部署另一个边缘池 (但尚未) 的其他边缘池，请部署该池。 有关详细信息，请参阅 [在 Lync Server 2013 中部署外部用户访问](lync-server-2013-deploying-external-user-access.md)。

2.  在新边缘池中的每个边缘服务器上，现在将托管 XMPP 联合 (EdgePool2) ，请运行以下 cmdlet：
