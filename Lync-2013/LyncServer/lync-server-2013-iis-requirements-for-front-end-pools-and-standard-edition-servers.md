...
对于标准版服务器和前端服务器以及控制器，Lync Server 2013 安装程序在 Internet 信息服务中创建虚拟目录 (IIS) ，目的如下：
...
> [!IMPORTANT]
> 如果你的组织要求在除系统驱动器之外的驱动器上找到 IIS 和所有 Web 服务，则可以在 "设置" 对话框中更改 Lync Server 文件的安装位置路径。 如果将安装文件安装到此路径（包括 OCSCore.msi），则其他 Lync Server 文件也将同时部署到此驱动器。 有关如何重新定位 Windows Server Manager 在安装 IIS 时部署的 INETPUB 的详细信息，请参阅 <A href="https://go.microsoft.com/fwlink/p/?linkid=216888">https://go.microsoft.com/fwlink/p/?linkId=216888</A> 。
...
<td><p>统一通信的位置 (适用于内部 UC 设备的 UC) 设备更新文件。</p></td>
</tr>
<tr class="even">
<td><p>会议</p></td>
