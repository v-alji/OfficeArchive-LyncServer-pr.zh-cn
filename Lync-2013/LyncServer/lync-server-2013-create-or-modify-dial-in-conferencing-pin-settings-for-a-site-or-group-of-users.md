...
请按照以下步骤创建或修改用户级电话拨入式会议个人识别码 (引脚) 策略。 有关如何更改全局 PIN 策略的详细信息，请参阅 [在 Lync Server 2013 中修改默认电话拨入式会议 PIN 设置](lync-server-2013-modify-the-default-dial-in-conferencing-pin-settings.md)。
