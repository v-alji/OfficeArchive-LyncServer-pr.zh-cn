...
<ul>
<li><p>第二和第三代英特尔高质图形2000、2500、3000和4000芯片组 (或更高版本，) 集成的硬件视频编码器。 需要安装 Intel 高清显卡驱动程序 15.28.9.2884 或包含以下内容的最新驱动程序：</p>
<ul>
<li><p>显示驱动程序 9.17.10.2884 或最新驱动程序</p></li>
<li><p>硬件媒体基础转换 (HMFT) 版本 3.12.10.31 或最新 HMFT</p></li>
</ul></li>
</ul>
<p>支持以下 AMD 硬件加速视频编码解决方案 (需要 Lync Server 2013) 更新 CU1：</p>
<ul>
