...
SessionDetails 视图存储有关对等会话的信息，这些会话可以是 VoIP-VoIP 电话呼叫、两方 IM 会话或其他类型的会话。 此视图已在 Microsoft Lync Server 2013 中引入。
...
<td><p>datetime</p></td>
<td><p>第一次邀请请求的时间。 此字段通常由会话中的初始邀请消息所生成的数据填充。 如果没有邀请消息，则该字段将填充第一条相关 SIP 消息的日期和时间， (再见、取消、消息或信息) 。 此字段通常由会话中的初始邀请消息所生成的数据填充。 如果没有邀请消息，则该字段将填充第一条相关 SIP 消息的日期和时间， (再见、取消、消息或信息) 。</p></td>
</tr>
<tr class="even">
...
<td><p>datetime</p></td>
<td><p>对第一个邀请消息的答复时间。 此字段通常由会话中的初始邀请消息所生成的数据填充。 如果没有邀请消息，则该字段将填充第一条相关 SIP 消息的日期和时间， (再见、取消、消息或信息) 。</p></td>
</tr>
<tr class="odd">
...
<td><p>nvarchar(256)</p></td>
<td><p>启动会话的用户所使用的边缘服务器的 FQDN。</p></td>
</tr>
<tr class="odd">
