...
将 Office 通信服务器 2007 R2 拓扑信息与 Lync Server 2013 试验池合并后，您需要运行 Lync Server 2013 Management Shell cmdlet 将 Office 通信服务器 2007 R2 策略和配置设置迁移到 Lync Server 2013 试验池。
