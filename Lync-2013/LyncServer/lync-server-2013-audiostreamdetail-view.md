...
<td><p>呼叫方终结点 (操作系统) 的操作系统。</p></td>
</tr>
<tr class="odd">
<td><p>CalleeOS</p></td>
<td><p>nvarchar (128) </p></td>
<td><p>被调用方终结点的操作系统 (操作系统) 。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p>在给定各种策略设置 (、API、SDP、策略服务器等) 的情况下，应用到给定发送方流的实际带宽。 此操作不会与有效的带宽混淆，因为根据带宽估计，可能会有较低的有效带宽。 这基本上是发送流对带宽估计所施加限制限制的最大带宽</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p> (AGC) 的自动增益控制应用于呼叫方音频的中介服务器端。</p></td>
</tr>
<tr class="odd">
<td><p>CallerInitialSignalLevelRMS</p></td>
<td><p>float</p></td>
<td><p>根平均值平方 (将传入信号的 RMS) 到呼叫者的前30秒。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p> (AGC) 的自动增益控制应用于被调用方的音频的中介服务器端。</p></td>
</tr>
<tr class="even">
<td><p>CalleeInitialSignalLevelRMS</p></td>
<td><p>float</p></td>
<td><p>根平均值平方 (RMS 传入信号的 RMS) ，最多可拨出前30秒的呼叫。</p></td>
</tr>
<tr class="odd">
