...
ms.locfileid: "49434345"
---
# <a name="conferencing-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的会议 cmdlet
...
**CsDialInConferencing** cmdlet 用于配置电话拨入式会议属性，包括从指定用户可以呼叫的电话号码到用户在加入会议后可用的电话号码等的所有内容，例如，按6将) 电话静音或取消静音，将其加入会议 (。 会议的大多数其他功能 (例如，用户可以录制会议，用户可以在会议期间共享应用程序，如此) 通过使用 **CsConferencingPolicy** cmdlet 进行管理。
...
**[Lync Server 2013 中的 Web 会议 cmdlet](lync-server-2013-web-conferencing-cmdlets.md)**
