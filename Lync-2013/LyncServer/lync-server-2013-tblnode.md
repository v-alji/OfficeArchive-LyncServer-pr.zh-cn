...
tblNode 包含类别或聊天室节点 (的对象树，) 在 Lync Server 2013 控制面板和管理 cmdlet 中托管。
...
<td><p>parentID</p></td>
<td><p>int</p></td>
<td><p>父项的节点 ID。 ID 为 1) 的根节点 (将其本身包含到父节点。</p></td>
</tr>
<tr class="even">
<td><p>nodeType</p></td>
...
<td><p>禁用</p></td>
<td><p>位，not null</p></td>
<td><p>如果禁用聊天室，则为 True。 仅适用于聊天室。 对类别 (False。 ) </p></td>
</tr>
<tr class="odd">
<td></td>
<td></td>
...
<td><p>在 EnumValue 表) 中查找的行为 (：</p>
<ul>
<li><p>4：正常 (正常聊天会议室) 。</p></li>
...
<td><p>siopID</p></td>
<td><p>GUID</p></td>
<td><p>如果外接程序与此聊天室关联，则 Add-In GUID。  (类别没有外接程序。 ) </p>
...
<td><p>purgedOn</p></td>
<td><p>datetime</p></td>
<td><p>最新的清除操作的时间 (从影响此节点的 tblPrincipalRole table) 中删除 tblScopedPrincipal 表和角色中的作用域。 此功能由聊天服务的内部缓存更新机制使用。</p></td>
</tr>
</tbody>
</table>
