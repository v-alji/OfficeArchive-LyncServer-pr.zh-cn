...
若要确定你的硬件负载平衡器是否支持 Lync Server 2013 所需的功能，请参阅 at 中的 "Lync Server 2010 负载平衡器合作伙伴" [https://go.microsoft.com/fwlink/p/?linkId=202452](https://go.microsoft.com/fwlink/p/?linkid=202452) 。
...
以下是控制器和前端池 Web 服务的硬件负载平衡器要求：
  ...
  - 对于内部 Web 服务 Vip，请 \_ 在硬件负载平衡器上设置源地址持久性 (内部端口80、443) 。 对于 Lync Server 2013，源 \_ 地址持久性意味着来自单个 IP 地址的多个连接始终发送到一台服务器，以维护会话状态。
...
在硬件负载平衡器上定义端口监控来确定特定服务何时由于硬件或通信故障而不再可用。 例如，如果前端服务器服务 (RTCSRV) 停止，因为前端服务器或前端池出现故障，则 HLB 监视还应停止接收 Web 服务的流量。 可在 HLB 上实施端口监控来监控以下各项：
