...
---
# <a name="mobile-phones-policypush-notification-in-lync-server-2013"></a>移动电话 (Lync Server 2013 中的策略/推送通知) 
...
## <a name="in-this-section"></a>本节内容
  ...
  - [Lync Server 2013 中的推送通知](lync-server-2013-push-notifications.md)
