...
<td><p>十进制 (5，2) </p></td>
<td><p> </p></td>
<td><p>会话百分比为 "坏" 状态引发 DeviceGlitches 事件的百分比。 呈现导致扭曲的音频有严重的难题。 这些故障可能是由驱动程序问题、延迟的过程调用 (DPC) 风暴 (驱动程序) 和 CPU 使用率较高导致的。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p> </p></td>
<td><p>会话期间的次数 DeviceHowlingEvent 事件针对 "错误" 状态引发。 检测到的音频反馈循环 (由多个终结点共享音频路径) 导致的。</p></td>
</tr>
<tr class="odd">
