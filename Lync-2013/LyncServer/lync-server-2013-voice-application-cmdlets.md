...
description: Lync Server 2013：语音应用程序 cmdlet。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
语音应用程序在前端服务器上的应用程序服务上运行。 这些应用程序通过允许您停止呼叫、处理未分配的号码、与 Exchange 统一消息 (UM) 以及运行响应组应用程序，帮助您管理拨入和拨出的电话。
