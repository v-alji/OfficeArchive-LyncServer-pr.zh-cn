...
若要使远程访问适用于任何 edge 服务，必须确保 SIP 流量能够流过 bidirectionally，如入站/出站边缘流量图所示。 另外一种方法是，在即时消息 (IM) 、状态、web 会议、音频/视频 (A/V) 和联盟）中涉及到 "访问边缘" 服务的 SIP 消息。
...
<td><p>SIP/MTLS/TCP/5061</p></td>
<td><p>边缘服务器内部接口</p></td>
<td><p>任何 (都可以定义为 Director、Director pool IP 地址、前端服务器或前端池地址) </p></td>
