...
description: Lync Server 2013：集中式日志记录 cmdlet。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
<!-- end list -->
  ...
  - [开始-CsClsLogging](https://technet.microsoft.com/library/JJ619190(v=OCS.15))

  - [停止-CsClsLogging](https://technet.microsoft.com/library/JJ619180(v=OCS.15))
