...
<td><p>int</p></td>
<td><p> </p></td>
<td><p>有关交互式连接建立 (ICE) 过程的信息在 bits 标志中描述。 有关详细信息，请参阅可供下载的 <em>体验质量监视服务器协议规范</em>。</p></td>
</tr>
<tr class="even">
...
<td><p>bit</p></td>
<td></td>
<td><p>呼叫者的链接。 1是虚拟专用网 (VPN) ，0是非 VPN。</p></td>
</tr>
<tr class="odd">
...
<td><p>bit</p></td>
<td><p> </p></td>
<td><p>呼叫接收器的链接;1是虚拟专用网 (VPN) ，0是非 VPN。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td></td>
<td><p>这是应用到给定发送端流的实际带宽，在给定各种策略设置 (转换、API、SDP、策略服务器等) 。 此操作不会与有效的带宽混淆，因为根据带宽估计，可能会有较低的有效带宽。 这基本上是发送流可以通过带宽估计限制限制的最大带宽。</p></td>
</tr>
<tr class="odd">
<td><p><strong>AppliedBandwidthSourceKey</strong></p></td>
<td><p>smallint</p></td>
<td></td>
<td><p>这是所强加的带宽上限的来源。 它介绍带宽限制来自 ( "策略服务器"、"打开服务器"、"模态" 等) 。 从 <a href="lync-server-2013-appliedbandwidthsource-table.md">Lync Server 2013 中的 AppliedBandwidthSource 表</a>引用。</p></td>
</tr>
<tr class="even">
...
<td><p>bit</p></td>
<td></td>
<td><p>指明呼叫是否分类为不太好的通话 (值为 1) 或 (0) 的良好通话。</p>
<p>此列已在 Microsoft Lync Server 2013 中引入。</p></td>
</tr>
<tr class="even">
...
<td><p>tinyInt</p></td>
<td></td>
<td><p>指示呼叫者是否使用 ICE 协议连接到网络 (Internet 连接建立) 。</p>
<p>此列已在 Microsoft Lync Server 2013 中引入。</p></td>
</tr>
<tr class="odd">
