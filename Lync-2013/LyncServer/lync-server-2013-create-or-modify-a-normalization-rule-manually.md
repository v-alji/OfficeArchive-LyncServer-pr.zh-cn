...
3.   (可选) 按照在 [Lync server 2013 中创建拨号计划](lync-server-2013-create-a-dial-plan.md) 或 [在 lync Server 2013 中修改拨号计划](lync-server-2013-modify-a-dial-plan.md)中的步骤进行操作。
...
7.  在“键入正则表达式”中输入以下内容：
    ...
    例如，如果你在 **翻译规则** 中输入 **^ (\\ d {7}) $** 与 **此模式** 和 **+ 1425 $ 1** ，则规则会将5550100标准化到 + 14255550100。
