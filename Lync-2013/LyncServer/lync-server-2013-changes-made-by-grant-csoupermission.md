...
若要委派 Lync Server 2013 管理，可以向指定组织单位 (Ou) 添加权限，以便林准备创建的 RTC 通用组的成员无需成为域管理员组的成员即可访问 Ou。
...
<p>阅读 Public-Information</p>
<p>阅读 General-Information</p>
<p>阅读用户-帐户限制</p></td>
<td><p>子代用户对象</p></td>
</tr>
<tr class="odd">
