...
---
# <a name="planning-for-manageability-and-virtualization-in-lync-server-2013"></a>在 Lync Server 2013 中规划可管理性和虚拟化
...
本部分包括有关规划 Lync Server 2013 部署的简单管理的主题。
...
## <a name="in-this-section"></a>本节内容
  ...
  - [在虚拟服务器上运行 Lync Server 2013](lync-server-2013-running-lync-server-on-virtual-servers.md)

  - [Lync Server 2013 中的双重身份验证](lync-server-2013-planning-for-and-deploying-two-factor-authentication.md)
