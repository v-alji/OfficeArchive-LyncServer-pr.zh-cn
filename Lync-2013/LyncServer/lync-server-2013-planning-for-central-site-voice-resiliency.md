...
<td><p>如果 DNS SRV 不可用，则客户端将尝试使用 DHCP 选项 120 来发现注册器。 为使此操作正常运行，必须配置 DHCP 服务器或启用 Lync Server 2013 DHCP。 有关详细信息，请参阅 <a href="lync-server-2013-branch-site-resiliency-requirements.md">Lync Server 2013 部分的分支站点恢复要求</a> 中 Branch-Site 复原的硬件和软件要求。</p></td>
</tr>
</tbody>
</table>
