...
7.  如果存在已知媒体终结点，请选中 " **集中媒体处理** " 复选框 (例如，公共交换电话网络 (PSTN) 网关，其中媒体端接的 IP 地址与信号终止) 相同。 如果中继没有已知的媒体端点，则清除该复选框。
...
13. **启用前向 P 声明的标识数据** 应选中以启用 PAI 呼叫发起人信息，以便在中介服务器端和网关方 (之间转发，反之亦然，) （如果存在）。
