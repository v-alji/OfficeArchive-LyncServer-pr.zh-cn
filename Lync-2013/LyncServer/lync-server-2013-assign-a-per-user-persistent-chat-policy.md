...
## <a name="assigning-a-per-user-persistent-chat-policy-by-using-windows-powershell-cmdlets"></a>使用 Windows PowerShell Cmdlet 分配 Per-User 持久聊天策略
...
## <a name="to-assign-a-per-user-persistent-chat-policy-to-multiple-users"></a>将每用户持久聊天策略分配给多个用户
  ...
  - 此命令将每用户持久聊天策略 RedmondUsersPersistentChatPolicy 分配给所有适用于 IT 部门的用户。 有关此命令中使用的 LdapFilter 参数的详细信息，请参阅 [move-csuser](https://technet.microsoft.com/library/gg398125\(v=ocs.15\)) cmdlet 的文档。
