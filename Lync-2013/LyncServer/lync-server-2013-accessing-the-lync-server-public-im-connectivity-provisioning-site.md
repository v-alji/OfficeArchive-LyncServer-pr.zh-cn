...
与以前的 PIC 预配方法相比，Lync-Skype 连接的预配过程已发生更改。 完成此预配过程最多需要30天。 建议您在完成文档中的其余步骤之前先开始此过程。 为你的帐户完成 Lync-Skype 预配过程后，将激活该帐户，并为你的符合条件的用户启用公共 IM 连接。

### <a name="to-provision-lync-skype-connectivity-you-need-the-following-information"></a>若要设置 Lync-Skype 连接性，你需要以下信息：
...
<tr class="odd">
<td><ol>
<li><p><strong>https://pic.lync.com</strong>使用您的 Microsoft Windows LIVE ID 登录到网站。</p></li>
