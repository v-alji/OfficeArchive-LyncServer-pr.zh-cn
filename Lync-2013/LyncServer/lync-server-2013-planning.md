...
---
# <a name="planning-for-lync-server-2013"></a>规划 Lync Server 2013
...
## <a name="in-this-section"></a>本节内容
  ...
  - [在 Lync Server 2013 中规划可管理性和虚拟化](lync-server-2013-planning-for-manageability-and-virtualization.md)
  ...
  - [规划 Exchange Server 与 Lync Server 2013 的集成](lync-server-2013-planning-for-exchange-server-integration.md)
