...
<tr class="odd">
<td><p><a href="lync-server-2013-purgesettings-table-qoe.md">PurgeSettings 表 (Lync Server 2013 中的 QoE) </a></p></td>
<td><p>存储用于指定 (是否在 QoE 数据库中自动删除) 过时的体验记录质量的信息。</p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><a href="lync-server-2013-useragentdef-table-qoe.md">UserAgentDef 表 (Lync Server 2013 中的 QoE) </a></p></td>
...
<td><p>将会话初始协议 (SIP) 用户代理 (UA) 在音频和视频会话中使用的字符串和 UA 类型。</p></td>
</tr>
<tr class="even">
...
<td><p>将音频媒体质量指标存储在媒体行中。 这包括 (AEC) 和自动增益控制 (AGC) 指标的声音回声取消。</p></td>
</tr>
<tr class="even">
...
<td><p>存储服务器的汇总数据，这些数据仅用于 (QoE) 报告的体验质量。</p></td>
</tr>
<tr class="even">
